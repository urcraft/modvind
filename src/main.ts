...
<main class="shell">
 <header><a class="brand" href="./" aria-label="Modvind home">MODVIND<span class="wind-mark">≋</span><small>THE COMMUTE TO HERNING</small></a><div class="header-note">WEST JUTLAND, DENMARK<span>A little determination goes a long way.</span></div><button id="pause" class="icon-button" aria-label="Pause game" disabled>Ⅱ</button></header>
